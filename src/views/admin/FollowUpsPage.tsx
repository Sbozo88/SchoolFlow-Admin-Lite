...
import type { FollowUpReason, FollowUpStatus } from "@/types/followUp";
...
export function FollowUpsPage() {
  ...
  const [formValues, setFormValues] = useState({
    ...
    parentName: "",
    parentPhone: "",
    reason: "general_update" as FollowUpReason,
      ...
      <Modal isOpen={isFormOpen} onClose={() => setIsFormOpen(false)} title="Create Follow-up">
        <form onSubmit={handleSubmit} className="grid gap-4">
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <Select label="Reason" value={formValues.reason} onChange={e => setFormValues(prev => ({...prev, reason: e.target.value as FollowUpReason}))}>
